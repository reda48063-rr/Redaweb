...
export const faculties = [
  { id: "comp", name: "كلية الحاسوب" },
];

export const departments = [
  { id: "cyber", name: "الأمن السيبراني", facultyId: "comp", majors: ["الأمن السيبراني"], summary: "حماية الأنظمة، تحليل الثغرات، الاختبارات الأمنية." },
  { id: "se",    name: "هندسة البرمجيات", facultyId: "comp", majors: ["هندسة البرمجيات"], summary: "هندسة المتطلبات، التصميم، الاختبار وضمان الجودة." },
  ...
  { id: "prog",  name: "البرمجة", facultyId: "comp", majors: ["البرمجة"], summary: "أساسيات البرمجة، الخوارزميات، وهياكل البيانات." },
];
